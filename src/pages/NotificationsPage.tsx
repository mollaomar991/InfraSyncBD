...
function NotificationsPage() {
  ...
  return (
    <div className="page-stack">
      <PageHeader eyebrow="IN-APP NOTIFICATIONS" title="Notifications" description="View account, project, conflict, approval, complaint, and inspection updates." action={<button className="road-button road-button-secondary" onClick={markAllRead}>Mark All Read</button>} />
