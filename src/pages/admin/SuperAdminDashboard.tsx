  ...
  return (
    <div className="page-stack">
      <PageHeader
        ...
        description="Monitor account verification, department activity, project compliance, delays, conflicts, contractors, complaints, inspections, and restoration across the platform."
        actions={
      ...
      <div className="content-grid content-grid-2-1">
        ...
        <Panel title="System health" subtitle="Prototype operational indicators">
          <div className="metric-list">
            ...
            <ProgressBar value={73} label="Restoration compliance" />
          </div>
        </Panel>
      </div>
