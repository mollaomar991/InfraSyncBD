...
type PublicRole = Exclude<Role, 'super_admin'>;
...
const signupRoles: SignupRole[] = [
  {
    ...
    label: 'Citizen',
    icon: '●',
    note: 'View projects and submit complaints',
  },
  {
...
function SignupPage() {
  ...
  function chooseRole(role: PublicRole) {
    ...
    <div className={styles.screen}>
      <section className={styles.showcase}>
        ...
        <div className={styles.hero}>
          ...
          <p>
            Citizens receive immediate access. Government officers and
            contractors submit evidence for Super Admin verification before
