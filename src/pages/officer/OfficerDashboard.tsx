  ...
  return (
    <div className="page-stack">
      <PageHeader
        ...
        description="Create projects, coordinate with departments, complete approvals, assign contractors, review progress, manage complaints, and verify restoration."
        actions={
      ...
      <div className="content-grid content-grid-2-1">
        ...
        <Panel title="Today’s action queue" subtitle="Operational tasks assigned to officers">
          <div className="timeline-list">
            ...
            <Link to="/restoration" className="timeline-item">
              <span className="timeline-dot success" />
              <div>
                <strong>Verify road restoration</strong>
                <small>1 submission requires review</small>
              </div>
            </Link>
          </div>
        </Panel>
